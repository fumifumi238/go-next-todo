    ...
    <form onSubmit={handleSubmit} className="mb-6">
      <div className="flex gap-2">
        ...
        <button
          ...
          className="px-6 py-2 bg-primary text-var-primary-foreground rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed">
          {isSubmitting ? "追加中..." : "追加"}
        </button>
      </div>
    </form>
